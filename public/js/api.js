...
class Api {
	...
	/**
	 * Updates username and password for user
	 * 
	 * @param	newusername		new username for user (can be null)
	 * @param	newpassword		new password for user (can be null)
	 * 
	...
	/**
	 * Gets a single item from server
	 * 
	 * @param	itemid	id of item to get
	 * 
	 * @return	json with item or err
	 */
